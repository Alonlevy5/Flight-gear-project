...
public class MySerialServer implements Server {
	...
	public  void runServer()throws Exception {
		...
		if(port==5000)
			System.out.println("Solver Server is online on port: "+port+" ");
		else
			System.out.println("FlightGear Server is running on port: "+port+" ");
		...
		while(!stop){
			try{
				...
				if(port==5000)
					...
					System.out.println("FlightGear is now connected to the FlightGear Server ");
